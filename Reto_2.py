...
hombres_baja = hombres_normal = hombres_alta = 0
mujeres_baja = mujeres_normal = mujeres_alta = 0
...
for i in range(1, N + 1):
    ...
    if genero == 1:  
        if hemoglobina < 12.2:
            print("➡️ Hombre con alerta: BAJA")
            hombres_baja += 1
        elif hemoglobina <= 16.6:
            print("➡️ Hombre con alerta: NORMAL")
            hombres_normal += 1
        else:
            print("➡️ Hombre con alerta: ALTA")
            hombres_alta += 1
    else:  
        if hemoglobina < 12.6:
            print("➡️ Mujer con alerta: BAJA")
            mujeres_baja += 1
        elif hemoglobina <= 15:
            print("➡️ Mujer con alerta: NORMAL")
            mujeres_normal += 1
        else:
            print("➡️ Mujer con alerta: ALTA")
            mujeres_alta += 1
